...
@export var noiseScaleLight = 5
@export var noiseScaleHeavy = 20 

@onready var terrainMesh : MeshInstance3D = $"Sand Mesh"
@onready var terrainColider : CollisionShape3D = $"Sand Collision"
